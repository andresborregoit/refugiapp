...
describe('animal-status-transitions', () => {
  ...
  describe('canTransitionStatus', () => {
    it('allows valid transitions from admitted', () => {
      ...
      expect(canTransitionStatus(AnimalStatus.ADMITTED, AnimalStatus.AVAILABLE_FOR_ADOPTION)).toBe(
        true,
      );
    ...
    it('allows valid transitions from under_treatment', () => {
      ...
      expect(
        canTransitionStatus(AnimalStatus.UNDER_TREATMENT, AnimalStatus.AVAILABLE_FOR_ADOPTION),
      ).toBe(true);
    ...
    it('allows valid transitions from available_for_adoption', () => {
      expect(
        canTransitionStatus(AnimalStatus.AVAILABLE_FOR_ADOPTION, AnimalStatus.UNDER_TREATMENT),
      ).toBe(true);
      expect(canTransitionStatus(AnimalStatus.AVAILABLE_FOR_ADOPTION, AnimalStatus.ADOPTED)).toBe(
        true,
      );
      expect(canTransitionStatus(AnimalStatus.AVAILABLE_FOR_ADOPTION, AnimalStatus.DECEASED)).toBe(
        true,
      );
    });
    ...
    it('rejects transitions from adopted', () => {
      ...
      expect(canTransitionStatus(AnimalStatus.ADOPTED, AnimalStatus.AVAILABLE_FOR_ADOPTION)).toBe(
        false,
      );
    ...
    it('rejects transitions from deceased', () => {
      ...
      expect(canTransitionStatus(AnimalStatus.DECEASED, AnimalStatus.AVAILABLE_FOR_ADOPTION)).toBe(
        false,
      );
    });
